...
{
    delegate bool TryMakeDelegate(ref TokenReader reader, out Command? command, out Response? errorResponse);

    static readonly Response UnrecognizedCommand = new(ReplyCode.CommandNotImplemented, "Unrecognized command");

    readonly CommandFactory _smtpCommandFactory;

    public Parser(CommandFactory smtpCommandFactory)
    {
    ...
    public bool TryMake(ref ReadOnlySequence<byte> buffer, out Command? command, out Response? errorResponse)
    {
        ...
        static bool Make(ReadOnlySequence<byte> buffer, TryMakeDelegate tryMakeDelegate, out Command? command, out Response? errorResponse)
        {
    ...
    static bool MakeUnrecognized(ref TokenReader reader, out Command? command, out Response errorResponse)
    {
        command = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeHelo(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
        ...
        {
            var domainOrAddress = StringUtil.Create(address);
            if (!string.IsNullOrWhiteSpace(domainOrAddress))
            {
                command = _smtpCommandFactory.CreateHelo(domainOrAddress);
                return true;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeEhlo(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeMail(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeRcpt(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
        ...
        {
            errorResponse = new Response(ReplyCode.SyntaxError, "missing the TO:");
            return false;
        }
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeData(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeQuit(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeNoop(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeRset(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeStartTls(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
    ...
    /// <param name="errorResponse">The error that indicates why the command could not be made.</param>
    /// <returns>Returns true if a command could be made, false if not.</returns>
    public bool TryMakeAuth(ref TokenReader reader, out Command? command, out Response? errorResponse)
    {
        command = null;
        errorResponse = null;
        ...
        {
            var parameter = StringUtil.Create(base64);
            if (!string.IsNullOrWhiteSpace(parameter))
            {
                command = _smtpCommandFactory.CreateAuth(authenticationMethod, parameter);
                return true;
            }
        }
    ...
    public bool TryMakePath(ref TokenReader reader, out EmailAddress? mailbox)
    {
        mailbox = null;
    ...
    public bool TryMakeMailbox(ref TokenReader reader, out EmailAddress? mailbox)
    {
        mailbox = null;
        ...
        static EmailAddress CreateMailbox(ReadOnlySequence<byte> localpart, ReadOnlySequence<byte> domainOrAddress)
        {
            var userString = StringUtil.Create(localpart, Encoding.UTF8)?.Trim('"');
            if (string.IsNullOrWhiteSpace(userString))
                throw new Exception();
            var user = Regex.Unescape(userString);

            var domainString = StringUtil.Create(domainOrAddress);
            if (string.IsNullOrWhiteSpace(domainString))
                throw new Exception();

            return new EmailAddress(user, domainString);
        }
    }
    ...
    public bool TryMakeMailParameters(ref TokenReader reader, out IReadOnlyDictionary<string, string>? parameters)
    {
        ...
        while (reader.Peek() != default)
        {
            ...
            var key = StringUtil.Create(keyword);
            var val = StringUtil.Create(value);
