...
{
    public static readonly Response Ok = new(ReplyCode.Ok, "Ok");
    public static readonly Response ServiceReady = new(ReplyCode.ServiceReady, "ready when you are");
    public static readonly Response MailboxUnavailable = new(ReplyCode.MailboxUnavailable, "mailbox unavailable");
    public static readonly Response MailboxFull = new(ReplyCode.InsufficientStorage, "mailbox full");
    public static readonly Response MailboxNameNotAllowed = new(ReplyCode.MailboxNameNotAllowed, "mailbox name not allowed");
    public static readonly Response ServiceClosingTransmissionChannel = new(ReplyCode.ServiceClosingTransmissionChannel, "bye");
    public static readonly Response SyntaxError = new(ReplyCode.SyntaxError, "syntax error");
    public static readonly Response SizeLimitExceeded = new(ReplyCode.SizeLimitExceeded, "size limit exceeded");
    public static readonly Response NoValidRecipientsGiven = new(ReplyCode.TransactionFailed, "no valid recipients given");
    public static readonly Response AuthenticationFailed = new(ReplyCode.AuthenticationFailed, "authentication failed");
    public static readonly Response AuthenticationSuccessful = new(ReplyCode.AuthenticationSuccessful, "go ahead");
    public static readonly Response TransactionFailed = new(ReplyCode.TransactionFailed);
    public static readonly Response BadSequence = new(ReplyCode.BadSequence, "bad sequence of commands");
    public static readonly Response AuthenticationRequired = new(ReplyCode.AuthenticationRequired, "authentication required");
    ...
    public Response(ReplyCode replyCode, string? message = null)
    {
        ReplyCode = replyCode;
        Message = message;
    }
